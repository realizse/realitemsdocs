...
permalink: ridoc_supported_features.html
folder: ridoc
---
...
--------|-----------|-----------
Content re-use | Yes | Supports re-use through Liquid. You can re-use variables, snippets of code, entire pages, and more. In DITA speak, this includes conref and keyref. See [Content reuse][ridoc_content_reuse] for more details.|
