...
permalink: ridoc_install_jekyll_on_mac.html
folder: ridoc
---
...
Bundler goes out and retreives all the gems that are specified in a Jekyll project's Gemfile. If you have a gem that depends on other gems to work, Bundler will go out and retrieve all of the dependencies as well. (To learn more about Bundler, see [About Ruby Gems][ridoc_about_ruby_gems_etc].
...
## Serve the Real Items Documentation
