...
After you have created a digital identity you can now view it 2 ways in the TRACKER.
...
To pair a digital identity with a physical item we will need to physically associate a unique QR code/PIN combination to that item.  Using the TRACKER, you can print out the QR code/PIN combination and apply it to the item or the box containing the item.
